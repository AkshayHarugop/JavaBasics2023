...
public class problem12DateFashion {
//Q. You and your date are trying to get a table at a restaurant. The parameter "you" is the stylishness of your clothes, in the range 0..10, 
...
//		return 1; //maybe
//		return 2; //yes
//		you || date ==8 or more very stylish result is yes"2"
//		you || date ==2 or less result is no "0"
//		else maybe "1"
