...
public class problem37GreenTicket {
//Q. You have a green lottery ticket, with ints a, b, and c on it. If the numbers are all different from each other, the result is 0. 
